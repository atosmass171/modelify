...
def pausar_bot(bot_id):
    ...
    conn.close()
    return redirect(url_for("bot", product_uuid=bot["uuid"]))
...
def editar_bot(bot_id):
    ...
    # Parse mensagens JSON para lista antes do render_template
    mensagens = []
    if bot['mensagens']:
        try:
    ...
    if request.method == "POST":
        ...
        # pega mensagens do formulário (pode ser uma lista)
